...
def inception_v4(num_classes, dropout_keep_prob, weights_path, abstract):
    '''
    ...
    if abstract == False:
        ...
        print('Outputing Categories.')
    else:
        model = Model(inputs, net, name='inception_v4')
        print("Outputing Abstraction Vector.")
...
def create_model(num_classes=1001, dropout_keep_prob=0.8, weights_path=None, abstract=False):
	return inception_v4(num_classes, dropout_keep_prob, weights_path, abstract)
